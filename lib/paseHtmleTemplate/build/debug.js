...
async function instantiate(module, imports = {}) {
  ...
  const adaptedImports = {
    ...
    DOM: Object.assign(Object.create(__module0), {
      ...
      log(log) {
        // assembly/DOM/log(~lib/string/String) => void
        log = __liftString(log >>> 0);
        __module0.log(log);
      },
      endComponent(tag, props, id, parent, text, index) {
        // assembly/DOM/endComponent(~lib/string/String, ~lib/string/String, ~lib/string/String, ~lib/string/String | null, ~lib/string/String, f64) => void
        tag = __liftString(tag >>> 0);
        props = __liftString(props >>> 0);
        id = __liftString(id >>> 0);
        parent = __liftString(parent >>> 0);
        text = __liftString(text >>> 0);
        __module0.endComponent(tag, props, id, parent, text, index);
      },
  ...
  const adaptedExports = Object.setPrototypeOf({
    wasmParse(html_s, templateKEY) {
      // assembly/index/wasmParse(~lib/string/String, ~lib/string/String) => ~lib/array/Array<assembly/index/CreateElement>
      html_s = __retain(__lowerString(html_s) || __notnull());
      templateKEY = __lowerString(templateKEY) || __notnull();
      try {
        return __liftArray(pointer => __liftInternref(__getU32(pointer)), 2, exports.wasmParse(html_s, templateKEY) >>> 0);
      } finally {
        __release(html_s);
      }
    },
    wasmRender(elems) {
      // assembly/index/wasmRender(~lib/array/Array<assembly/index/CreateElement>) => ~lib/array/Array<assembly/index/Responsive>
      elems = __lowerArray((pointer, value) => { __setU32(pointer, __lowerInternref(value) || __notnull()); }, 6, 2, elems) || __notnull();
      return __liftArray(pointer => __liftInternref(__getU32(pointer)), 2, exports.wasmRender(elems) >>> 0);
    },
    wasmPatch(current, updatesStr) {
      // assembly/index/wasmPatch(~lib/array/Array<assembly/index/Responsive>, ~lib/string/String) => void
      current = __retain(__lowerArray((pointer, value) => { __setU32(pointer, __lowerInternref(value) || __notnull()); }, 11, 2, current) || __notnull());
    ...
    sum(d) {
      // assembly/index/sum(~lib/array/Array<assembly/index/CreateElement>) => ~lib/string/String
      d = __lowerArray((pointer, value) => { __setU32(pointer, __lowerInternref(value) || __notnull()); }, 6, 2, d) || __notnull();
      return __liftString(exports.sum(d) >>> 0);
    },
  }, exports);
